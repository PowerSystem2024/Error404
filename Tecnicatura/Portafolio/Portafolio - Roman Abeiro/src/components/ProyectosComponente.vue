<script setup>
import proyecto1 from '/src/assets/exProyect.png';
...
misProyectos.value = ([
    //esto es un array de objetos que contiene información sobre los proyectos
    {
        ...
        src: proyecto1,
        titulo: "Proyecto 1",
        descripcion: "El proyecto fue diseñado para resolver una necesidad específica, combinando tecnologías modernas y prácti...",
