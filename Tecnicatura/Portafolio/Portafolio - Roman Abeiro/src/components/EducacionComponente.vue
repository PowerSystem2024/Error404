...
const educacion = ref([
  ...
  {fecha: '2021', title: 'Curso de Arduino', descripcion: 'En este curso aprendí a programar y trabajar con la plataforma Arduino, creando proyectos electrónicos interactivos. Desarrollé habilidades en el uso de sensores, actuadores y circuitos, lo que me permitió construir dispositivos y sistemas automatizados.', enlace:'https://www.youtube.com/'},
  {fecha: '2021', title: 'Curso de Kotlin', descripcion: 'En este curso aprendí a desarrollar aplicaciones móviles y de escritorio utilizando Kotlin. Dominé la sintaxis del lenguaje, la programación orientada a objetos y la integración con Android Studio, lo que me permitió crear aplicaciones funcionales y eficientes para diversas plataformas.', enlace:'https://www.youtube.com/'},
  {fecha: '2020', title: 'Curso Básico de HTML, CSS y JS', descripcion: 'En este curso aprendí los fundamentos del desarrollo web, creando páginas estáticas con HTML, estilándolas con CSS y agregando interactividad con JavaScript. Desarrollé habilidades para construir sitios web básicos y entender el flujo de trabajo front-end.', enlace:'https://www.youtube.com/'},
]);
</script>
