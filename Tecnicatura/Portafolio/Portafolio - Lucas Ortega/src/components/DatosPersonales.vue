...
const redesSociales = [
  { id: 1, name: 'linkedin', src: linkedin, url: 'https://www.linkedin.com/in/lucas-n-ortega/' },
  { id: 3, name: 'github', src: github, url: 'https://github.com/LucOrt91' },
  { id: 4, name: 'curriculum', src: cv, url: 'https://drive.google.com/file/d/1fRzMkc4KzhKm-JogvzjldRA3XK7iJoDI/view?usp=drive_link' },
];
const telefono = '+54 9 261 5587079';
</script>
