...
const educacion = ref([
  ...
  },
  {
    ...
    title: 'Especialización en ASP.NET para Desarrolladores Experimentados',
    descripcion: 'Certificación en ASP.NET en Coursera, cubriendo C#, desarrollo backend y microservicios.',
    enlace: 'https://www.coursera.org/',
  },
  {
    fecha: 'Septiembre 2022',
    title: 'Foundational C# with Microsoft',
    descripcion: 'Certificación completada en Free CodeCamp con 93.8% de respuestas correctas.',
