<script setup>
const title = 'Error404';
const descripcion = 'Técnico Universitario en Programación - UTN';
const residencia = 'Mendoza, Argentina';
const presentacion = 'Portfolio del Grupo "Error404", estudiantes de programación de la UTN de San Rafael. Conoce más sobre nosotros y nuestros proyectos.';
const redesSociales = [
