...
const educacion = ref([
  {fecha: '2024', title: 'Técnicatura Universitaria en Programación', descripcion: 'Formación profesional enfocada en la operación y programación de sistemas informáticos, con habilidades en el desarrollo de aplicaciones en varios lenguajes y el análisis de sistemas complejos.', enlace: 'https://www.frsr.utn.edu.ar/programacion/'},
]);
